...
exports.ROUTES = [
    ...
    { path: 'todo', title: 'Todo App', menuType: sidebar_metadata_1.MenuType.LEFT, icon: 'pe-7s-news-paper' },
    { path: 'client', title: 'Clients', menuType: sidebar_metadata_1.MenuType.LEFT, icon: 'pe-7s-users' },
